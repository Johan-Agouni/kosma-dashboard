...
const createProductValidation = [
    ...
    body('stock').isInt({ min: 0 }).withMessage('Le stock doit etre un entier positif'),
    body('category').isMongoId().withMessage('ID de categorie invalide'),
    body('status').optional().isIn(['active', 'draft', 'archived']).withMessage('Statut invalide'),
...
const updateProductValidation = [
    ...
    body('stock').optional().isInt({ min: 0 }).withMessage('Le stock doit etre un entier positif'),
    body('category').optional().isMongoId().withMessage('ID de categorie invalide'),
    body('status').optional().isIn(['active', 'draft', 'archived']).withMessage('Statut invalide'),
];
